...
class ProdutosDisponiveis extends StatefulWidget {
  const ProdutosDisponiveis({super.key});

  @override
  State<ProdutosDisponiveis> createState() => _ProdutosDisponiveisState();
}

class _ProdutosDisponiveisState extends State<ProdutosDisponiveis> {
  @override
      ...
      body: Container(
        decoration: const BoxDecoration(
          gradient: LinearGradient(
            ...
            colors: <Color>[
              Color.fromRGBO(0, 114, 223, 100),
              Color.fromRGBO(0, 223, 197, 100)
            ],
          ),
        ),
        child: Container(
